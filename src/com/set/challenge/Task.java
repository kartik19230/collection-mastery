...
public class Task implements Comparable<Task>{
    ...
    public Task(String project, String description, String assigne, Priority priority, Status status) {
    ...
    public String toString() {
        return "%-20s %-25s %-10s %-10s %s".formatted(project,description,
    ...
    public int compareTo(Task o) {
        int n = this.project.compareTo(o.project);
        if (n == 0){
            n = this.description.compareTo(o.description);
        }
        return n;
    }
}
